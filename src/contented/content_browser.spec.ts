...
describe('TestingContentBrowserCmp', () => {
  ...
  beforeEach(async () => {
    ...
    providers: [ContentedService, provideRouter([{ path: 'ui/browse/:idx/:rowIdx', component: ContentBrowserCmp }]), provideHttpClient(withInterceptorsFromDi()), provideHttpClientTesting()]
}).compileComponents();
