...
export class NavEvents {
  ...
  // Determine if this should require a content element
  favoriteContent(content: Content | undefined) {
    this.navEvts.emit({
  ...
  removeFavorite(content: Content | undefined) {
    this.navEvts.emit({
  ...
  scrollContentView(content: Content | undefined) {
    this.navEvts.emit({
  ...
  toggleDuplicate(content: Content | undefined) {
    this.navEvts.emit({
  ...
  removeDuplicate(content: Content | undefined) {
    this.navEvts.emit({
