...
const appRoutes: Routes = [
  ...
  {
    path: 'admin_ui/search',
    component: AdminSearchCmp,
    data: { title: 'Administrate Content' },
  },
];
@NgModule({
